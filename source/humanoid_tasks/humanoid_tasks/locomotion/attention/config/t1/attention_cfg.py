...
import booster_mdp
from booster_assets import T1_CFG
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        height_scan = ObsTerm(
            func=booster_mdp.height_scan_3d,
        ...
        foot_force = ObsTerm(
            ...
            params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names="l[lr]6")},
...
class RewardsCfg:
    ...
    joint_arm_pos = RewTerm(
        ...
        params={"asset_cfg": SceneEntityCfg(
            "robot",
            joint_names=["joint_a[lr].*", "joint_l[lr]2", "joint_waist"]
...
@configclass
class T1AttentionModuleCfg(ManagerBasedRLEnvCfg):
...
class T1AttentionModule_PLAY(T1AttentionModuleCfg):
    def __post_init__(self) -> None:
        # post init of parent
        super().__post_init__()
