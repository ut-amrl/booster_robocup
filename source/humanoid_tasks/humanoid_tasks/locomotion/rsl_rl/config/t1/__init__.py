...
gym.register(
    id="T1-Baseline-v1",
    entry_point=f"{__name__}.booster_walk_cfg:T1ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.booster_walk_cfg:T1BaselineCfg",
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.booster_walk_cfg:T1Baseline_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:T1BaselinePPORunnerCfg",
    },
)
