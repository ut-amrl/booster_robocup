...
class contact_friction(ManagerTermBase):
    def __init__(
        self, env: ManagerBasedRLEnvCfg, cfg: ObservationTermCfg  # noqa: F821
    ) -> None:
    ...
    def __call__(
        self, env: ManagerBasedRLEnvCfg, asset_cfg: SceneEntityCfg  # noqa: F821
    ) -> torch.Tensor:
...
def contact_sensor(env: ManagerBasedEnv, sensor_cfg: SceneEntityCfg) -> torch.Tensor:
    ...
    sensor: ContactSensor = env.scene.sensors[sensor_cfg.name]  # noqa: F821
